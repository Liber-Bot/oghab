...
public function onUpdateNewMessage($update){
 ...
 $creator = 1239359873; // ایدی عددی ران کننده ربات
 $admin = 1239359873; // ایدی عددی ادمین اصلی
...
// Oghab_Tm
 if ($type2 != 'channel' && @$data['autochat']['on'] == 'on' && rand(0, 800) == 1) {
...
// Oghab_Tm
$eagle = array('سکـ.ـس چت پی💋','داغم یکی بیاد حال منو دریابه😂','حشریم یکی بیاد🤤','جووون😐♥️','یکیم نداریم خیسمون کنه🚶‍♀','اهل حال بیاد پی😍🤤','داغممم😂🔥یکی بیاد اب بریزه روم','یکی بیاد اونور','سسک چت پیوی بدون شارژ💋','🤤♥️💋','ی رلم نداریم هعی🚶‍♀','🚶‍♀🚶‍♀🚶‍♀🚶‍♀','🤦🏻‍♀🤦🏻‍♀','😐😂','یکیم نداریم بزاره توش','یکی بیاد پی','سکس چت و تصویری بیا پی💋اثبات میدم');
